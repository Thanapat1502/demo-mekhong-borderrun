              ...
              {journeySteps.map((step, index) => (
                <div key={index} className="relative">
                  ...
                  <div className="flex items-start gap-8 pb-16">
                    {/* Step Number */}
                    <div className="flex-shrink-0 w-12 h-12 bg-gray-900 text-white rounded-full flex items-center justify-center text-base font-medium">
                      {step.step}
                    </div>
                    ...
                    <div className="flex-1 pt-2">
                      <div className="flex items-baseline gap-4 mb-2">
                        <span className="text-base font-mono text-accent-600 bg-accent-50 px-2 py-1 rounded">
                          {step.time}
                        </span>
              ...
              <div className="grid grid-cols-2 gap-3">
                {galleryImagesData.map((imageData, index) => (
                  <div
                    ...
                    {/* Image Number */}
                    <div className="absolute top-2 left-2 w-6 h-6 bg-white/90 rounded-full flex items-center justify-center text-base font-medium text-gray-700 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      {index + 1}
                    </div>

                    {/* Image Title on Hover */}
                    <div className="absolute bottom-2 left-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <div className="bg-black/70 text-white px-2 py-1 rounded text-base">
                        {imageData.title}
                      </div>
                    </div>
                  </div>
